...
(((n << 16) >> 24) << 16) | (n >> 24))
/**
* verify - verifies the file to check if is a ELF
* @e_ident: ELF struct
* return: void
*/
...
/**
* class - prints the class of the ELF
...
/**
* version - prinst the version of the file
* @e_ident: the ELF struct
* return: void
*/
